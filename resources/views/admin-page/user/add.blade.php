                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="form-group @if($errors->has('nip')) has-error @endif">
                                ...
                                <input name="nip" type="text" class="form-control" placeholder="NIP" value="@if(count($errors) > 0){{old('nip')}}@endif" />
                            ...
                            <div class="form-group @if($errors->has('name')) has-error @endif">
                                ...
                                <input name="name" type="text" class="form-control" placeholder="Name user" value="@if(count($errors) > 0){{old('name')}}@endif" />
                            ...
                            <div class="form-group @if($errors->has('email')) has-error @endif">
                                ...
                                <input id="email" type="text" name="email" class="form-control" placeholder="Email" value="@if(count($errors) > 0){{old('email')}}@endif" />
                            ...
                            <div class="form-group @if($errors->has('password')) has-error @endif">
                                ...
                                <input id="password" type="password" name="password" class="form-control" placeholder="Password" value="@if(count($errors) > 0){{old('password')}}@endif" />
                            ...
                            <div class="form-group @if($errors->has('jabatan')) has-error @endif">
                                ...
                                <select name="jabatan" id="jabatan" class="form-control" required>
                                    ...
                                    @if(!$user_kades)
                                    <option value="kepala_desa" @if(count($errors) > 0 && old('jabatan') == 'kepala_desa') selected @endif>Kepala Desa</option>
                                    @endif
                                    @if(!$user_sekdes)
                                    <option value="sekdes" @if(count($errors) > 0 && old('jabatan') == 'sekdes') selected @endif>Sekretaris Desa</option>
                                    @endif
                                    <option value="admin" @if(count($errors) > 0 && old('jabatan') == 'admin') selected @endif>Admin Desa</option>
                                </select>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <img id="image-display" src="@if(count($errors) > 0 && old('foto') != ''){{asset('upload/user/large/'. old('foto'))}}@else{{ asset('assets/images/600x400.png') }}@endif" alt="Image user" class="img-thumbnail">
                            </div>
