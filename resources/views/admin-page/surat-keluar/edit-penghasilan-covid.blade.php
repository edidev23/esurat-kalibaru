    ...
    <div class="col-lg-12">
        <div class="inqbox float-e-margins">
            <div class="inqbox-content">
                <form action="{{url('admin/surat-keluar', $surat_keluar->id)}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <p class="text-center text-heading">Nomor: {{ $jenis_surat->kode }}/
                                <input type="text" name="no_agenda" value="{{ $surat_keluar->no_agenda }}"
                                    style="width: 50px">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="height-70">: @if($ttd_pimpinan->jabatan == 'kepala_desa') Kepala Desa
                                        {{ $profil_desa->desa }} @elseif($ttd_pimpinan->jabatan == 'sekdes') Sekretaris
                                        Desa {{ $profil_desa->desa }} @endif</td>
                                </tr>
                            </table>
                        ...
                        <div class="col-lg-12">
                            <div class="section mt-5">
                                ...
                                <textarea name="keterangan" id="keterangan" placeholder="keterangan"
                                    required>{{ $surat_keluar->keterangan }}</textarea>
                            </div>
                        </div>
