    ...
    <div class="col-lg-12">
        <div class="inqbox float-e-margins">
            <div class="inqbox-content">
                <form  action="{{url('admin/surat-keluar-internal', $surat_keluar_internal->id)}}" method="post" enctype="multipart/form-data">
                    @method('PUT')
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group @if($errors->has('no_agenda')) has-error @endif">
                                ...
                                <input id="no_agenda" type="text" name="no_agenda" class="form-control" placeholder="No Agenda" value="@if(count($errors) > 0){{old('no_agenda')}}@else{{$surat_keluar_internal->no_agenda}}@endif" />
                            ...
                            <div class="form-group @if($errors->has('pengirim')) has-error @endif">
                                ...
                                <input id="pengirim" type="text" name="pengirim" class="form-control" placeholder="Pengirim" value="@if(count($errors) > 0){{old('pengirim')}}@else{{$surat_keluar_internal->pengirim}}@endif" />
                            ...
                            <div class="form-group @if($errors->has('tgl_surat')) has-error @endif">
                                ...
                                <div class="input-group date">
                                    <input id="tgl_surat" type="text" name="tgl_surat" class="form-control datepicker" placeholder="Tanggal Surat" value="@if(count($errors) > 0){{old('tgl_surat')}}@else{{ tanggal_id($surat_keluar_internal->tgl_surat) }}@endif" />
                            ...
                            <div class="form-group @if($errors->has('tgl_keluar')) has-error @endif">
                                ...
                                <div class="input-group date">
                                    <input id="tgl_keluar" type="text" name="tgl_keluar" class="form-control datepicker" placeholder="Tanggal Surat" value="@if(count($errors) > 0){{old('tgl_keluar')}}@else{{ tanggal_id($surat_keluar_internal->tgl_keluar)}}@endif" />
                                    <span class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                    </span>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group @if($errors->has('kepada')) has-error @endif">
                                ...
                                <input id="kepada" type="text" name="kepada" class="form-control" placeholder="Kepada" value="@if(count($errors) > 0){{old('kepada')}}@else{{$surat_keluar_internal->kepada}}@endif" />
                            ...
                            <div class="form-group @if($errors->has('tujuan')) has-error @endif">
                                ...
                                <input id="tujuan" type="text" name="tujuan" class="form-control" placeholder="Tujuan" value="@if(count($errors) > 0){{old('tujuan')}}@else{{$surat_keluar_internal->tujuan}}@endif" />
                            ...
                            <div class="form-group @if($errors->has('perihal')) has-error @endif">
                                ...
                                <input id="perihal" type="text" name="perihal" class="form-control" placeholder="Perihal" value="@if(count($errors) > 0){{old('perihal')}}@else{{$surat_keluar_internal->perihal}}@endif" />
                            ...
                            <div class="form-group @if($errors->has('keterangan')) has-error @endif">
                                ...
                                <textarea name="keterangan" id="keterangan" class="form-control">@if(count($errors) > 0){{old('keterangan')}}@else{{$surat_keluar_internal->keterangan}}@endif</textarea>
                            ...
                            <div class="form-group @if($errors->has('file')) has-error @endif">
                                ...
                                @if($surat_keluar_internal->file != '')
                                    <div style="margin-top: 15px"> <a href="{{ asset('upload/arsip-surat-keluar-internal/'. $surat_keluar_internal->file) }}" target="_blank">Lihat dokumenn</a></div>
                                @endif
                            </div>
                        </div>
                    </div>
