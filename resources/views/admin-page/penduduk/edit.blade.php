                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group @if($errors->has('nama')) has-error @endif">
                                ...
                                <input id="nama" type="text" name="nama" class="form-control" placeholder="Nama" value="@if(count($errors) > 0){{old('nama')}}@else{{ $penduduk->nama}}@endif" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-group @if($errors->has('nik')) has-error @endif">
                                ...
                                <input id="nik" type="text" name="nik" class="form-control" placeholder="NIK" value="@if(count($errors) > 0){{old('nik')}}@else{{ $penduduk->nik }}@endif" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-group @if($errors->has('kk')) has-error @endif">
                                ...
                                <input id="kk" type="text" name="kk" class="form-control" placeholder="No KK" value="@if(count($errors) > 0){{old('kk')}}@else{{ $penduduk->kk }}@endif" />
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group @if($errors->has('tmp_lahir')) has-error @endif">
                                ...
                                <input id="tmp_lahir" type="text" name="tmp_lahir" class="form-control" placeholder="Tempat Lahir" value="@if(count($errors) > 0){{old('tmp_lahir')}}@else{{ $penduduk->tmp_lahir }}@endif" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-group @if($errors->has('tgl_lahir')) has-error @endif">
                                ...
                                <input id="tgl_lahir" type="text" name="tgl_lahir" class="form-control datepicker" placeholder="Tgl Lahir" value="@if(count($errors) > 0){{old('tgl_lahir')}}@else{{ tanggal_id($penduduk->tgl_lahir) }}@endif" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-group @if($errors->has('jkel')) has-error @endif">
                                ...
                                <br>
                                <label>
                                    <input type="radio" name="jkel" id="laki" value="L" @if($penduduk->jkel == 'L') checked @elseif(old('jkel') == 'L') checked @endif>
                                    Laki-laki
                                </label>

                                <label style="margin-left: 20px">
                                    <input type="radio" name="jkel" id="perempuan" value="P" @if($penduduk->jkel == 'P') checked @elseif(old('jkel') == 'P') checked @endif>
                                    Perempuan
                                </label>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group @if($errors->has('agama')) has-error @endif">
                                ...
                                <select name="agama" id="agama" class="form-control">
                                    ...
                                    <option value="islam" @if(old('agama') == 'islam' || $penduduk->agama == 'islam') selected @endif>Islam</option>
                                    <option value="kristen" @if(old('agama') == 'kristen' || $penduduk->agama == 'kristen') selected @endif>Kristen</option>
                                    <option value="katolik" @if(old('agama') == 'katolik' || $penduduk->agama == 'katolik') selected @endif>Katolik</option>
                                    <option value="hindu" @if(old('agama') == 'hindu' || $penduduk->agama == 'hindu') selected @endif>Hindu</option>
                                    <option value="budha" @if(old('agama') == 'budha' || $penduduk->agama == 'budha') selected @endif>Budha</option>
                                </select>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group @if($errors->has('status')) has-error @endif">
                                ...
                                <label>
                                    <input type="radio" name="status" id="belum" value="Belum Kawin" @if(old('status') == 'Belum Kawin' || $penduduk->status == 'Belum Kawin') checked @endif>
                                    Belum Kawin
                                </label>

                                <label style="margin-left: 20px">
                                    <input type="radio" name="status" id="kawin" value="Kawin" @if(old('status') == 'Kawin' || $penduduk->status == 'Kawin') checked @endif>
                                    Kawin
                                </label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group @if($errors->has('dusun')) has-error @endif">
                                ...
                                <input id="dusun" type="text" name="dusun" class="form-control" placeholder="Dusun" value="@if(count($errors) > 0){{old('dusun')}}@else{{ $penduduk->dusun }}@endif" />
                        ...
                        <div class="col-lg-1">
                            <div class="form-group @if($errors->has('rt')) has-error @endif">
                                ...
                                <input id="rt" type="text" name="rt" class="form-control" placeholder="RT" value="@if(count($errors) > 0){{old('rt')}}@else{{ $penduduk->rt }}@endif" />
                        ...
                        <div class="col-lg-1">
                            <div class="form-group @if($errors->has('rw')) has-error @endif">
                                ...
                                <input id="rw" type="text" name="rw" class="form-control" placeholder="RW" value="@if(count($errors) > 0){{old('rw')}}@else{{ $penduduk->rw }}@endif" />
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group @if($errors->has('desa')) has-error @endif">
                                ...
                                <input id="desa" type="text" name="desa" class="form-control" placeholder="Desa" value="@if(count($errors) > 0){{old('desa')}}@else{{ $penduduk->desa }}@endif" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-group @if($errors->has('kecamatan')) has-error @endif">
                                ...
                                <input id="kecamatan" type="text" name="kecamatan" class="form-control" placeholder="Kecamatan" value="@if(count($errors) > 0){{old('kecamatan')}}@else{{ $penduduk->kecamatan }}@endif" />
                        ...
                        <div class="col-lg-4">
                            <div class="form-group @if($errors->has('kabupaten')) has-error @endif">
                                ...
                                <input id="kabupaten" type="text" name="kabupaten" class="form-control" placeholder="Kabupaten" value="@if(count($errors) > 0){{old('kabupaten')}}@else{{ $penduduk->kabupaten }}@endif" />
