    ...
    <div class="col-lg-12">
        <div class="inqbox float-e-margins">
            <div class="inqbox-content">
                <form  action="{{url('admin/surat-masuk')}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group @if($errors->has('tgl_terima')) has-error @endif">
                                ...
                                <div class="input-group date">
                                    <input id="tgl_terima" type="text" name="tgl_terima" class="form-control datepicker" placeholder="Tanggal Surat" value="@if(count($errors) > 0){{old('tgl_terima')}}@endif" />
                                    <span class="input-group-addon">
                                        <i class="fa fa-calendar"></i>
                                    </span>
                                </div>
