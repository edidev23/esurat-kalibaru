...
<body>
    ...
    <div class="mt-2">
        <table width="100%">
            ...
            <tr>
                <td width="5%"></td>
                <td>Tempat/Tgl. Lahir/Usia</td>
                <td>: {{ $detail_penduduk->tmp_lahir }}, {{ tanggal_id($detail_penduduk->tgl_lahir) }}/usia</td>
            </tr>
            <tr>
                <td width="5%"></td>
                <td>Jenis Kelamin</td>
            ...
            <tr>
                <td width="5%"></td>
                <td>Agama</td>
                <td class="font-capitalize">: {{ $detail_penduduk->agama }}</td>
            </tr>
            <tr>
                <td width="5%"></td>
            ...
            <tr>
                ...
                <td>
                    <span style="line-height: 1.5em">
                        ...
                        &nbsp;&nbsp;Desa {{ $detail_penduduk->desa }} Kec. {{ $detail_penduduk->kecamatan }}
                    </span>
                </td>
            </tr>
        </table>
