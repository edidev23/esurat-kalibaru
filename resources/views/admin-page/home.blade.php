  ...
  <div class="tab-content">
    <div id="tab-suratkeluar" class="tab-pane active">
      <div class="panel-body">
        ...
        <a href="{{ url('admin/surat-keluar') }}">Lihat semua <i class="fa fa-arrow-right"
    ...
    <div id="tab-suratmasuk" class="tab-pane">
      <div class="panel-body">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="center">
                ...
                <a href="{{ url('admin/surat-masuk/'. $d->id .'/edit')}}" class="btn btn-info">
                  <i class="fa fa-pencil"></i>
                </a>
              </td>
            </tr>
        ...
        <a href="{{ url('admin/surat-masuk') }}">Lihat semua <i class="fa fa-arrow-right"
            style="margin-left:5px"></i></a>
      </div>
    </div>
  </div>
